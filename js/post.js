...
function pagination(info, currentPage, totalInPage){
    const firstItem = (currentPage - 1) * totalInPage;
    const lastItem = firstItem + totalInPage;
    const allItems = info.slice(firstItem, lastItem);
    return allItems;
}
...
// **** Note:There are bugs in this systems so that you cant get data from 20th item and behind ones
const data = [
  {
    userId: 1,
    id: 1,
